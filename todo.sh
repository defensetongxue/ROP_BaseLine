...
python -u  train.py --cfg ./configs/inceptionv3.json --split_name clr_1 
python -u  train.py --cfg ./configs/inceptionv3.json --split_name clr_2
python -u  train.py --cfg ./configs/inceptionv3.json --split_name clr_3
python -u  train.py --cfg ./configs/inceptionv3.json --split_name clr_4 
